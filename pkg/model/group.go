...
type Groups struct {
	...
	Status         int64          `gorm:"type:tinyint(4);default:0;index:idx_status" json:"status"` // 0 正常 1 禁用 2 解散
...
type GroupMembers struct {
	...
	Role      int64          `gorm:"type:tinyint(4);index:idx_role;default:0" json:"role"` // 0 普通成员 1 群主 2 管理员
	Nickname  string         `gorm:"type:varchar(50);" json:"nickname"`
	Status    int64          `gorm:"type:tinyint(4);default:0;" json:"status"`     // 0 正常 1 禁言（标志位，非必须）
